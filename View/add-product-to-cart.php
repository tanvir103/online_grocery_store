...
<body>
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while($row = mysqli_fetch_assoc($result)) {
            ...
            <td align=\"center\"><font face=\"times new roman\" size=\"4\"><a href=\"purchase-controller.php?id={$productID}\"><button class=\"round-button\">Purchase Product</button></font></a></td>
        </tr>";
        }
        echo" </table>";
    }else{
